...
class GameView {
  ...
  start() {
    ...
    $('.song-choice').on('click', () => {
      ...
      createjs.Sound.registerSound("/Users/tianhan/Documents/aivytran/DDR/aivytran.github.io/music/Dub-I-Dub.mp3", "sound1");
    })
    $('.song-choice1').on('click', () => {
      ...
      createjs.Sound.registerSound("/Users/tianhan/Documents/aivytran/DDR/aivytran.github.io/music/ShakeItOff.mp3", "sound2");
    })
